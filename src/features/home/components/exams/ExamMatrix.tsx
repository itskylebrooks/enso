  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        className={isFullWidth ? 'md:relative md:left-1/2 md:-ml-[50vw] md:w-screen' : ''}
      >
        <motion.div
          layout
          transition={{ duration: 0.24, ease: defaultEase }}
        ...
        >
          ...
          >
            ...
            <div className={isFullWidth ? '' : 'overflow-x-auto'}>
              ...
              <table
                role="grid"
                className={`${isFullWidth ? 'w-max' : 'w-full'} border-collapse text-sm`}
              >
                <thead>
                  <tr className="surface border-b surface-border">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="absolute inset-0 flex items-end justify-center px-1 py-2">
                            <span className="vertical-header leading-tight">
                              {col.label[locale]}
                            </span>
                          </div>
                        </th>
                    ...
                    <th
                      className="px-2 py-2 text-center font-semibold text-xs uppercase tracking-wide border-l surface-border"
                      style={{ minWidth: '50px' }}
                    >
                ...
                <tbody>
                  {allRows.map((row, rowIndex) => {
                    ...
                    return (
                      <Fragment key={row.id}>
                        <tr
                          className={`border-b surface-border ${isLastNageRow ? 'border-b-2' : ''}`}
                        >
