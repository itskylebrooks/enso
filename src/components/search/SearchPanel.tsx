...
export const Spotlight = ({ copy, locale, techniques, onNavigate }: SpotlightProps): ReactElement | null => {
  ...
  const activeOptionId = useMemo(() => {
    ...
    return `spotlight-option-${results[selectedIndex].item.id}`;
    ...
    <AnimatePresence>
      {open && (
        <Fragment>
          ...
          >
            <div
              className="w-[640px] max-w-[92vw] rounded-2xl border spotlight-surface p-3 shadow-xl"
            ...
            >
              ...
              />
              <div className="mt-3 rounded-2xl border spotlight-surface">
                <SpotlightList
                  results={results}
                  locale={locale}
