...
const SearchPanelResultItem = memo(
  ({ hit, index, locale, active, onSelect, onHover, buttonRef }: SearchPanelResultItemProps): ReactElement => {
    ...
    return (
      <button
        ...
        id={`search-panel-option-${item.id}`}
      >
...
SearchPanelResultItem.displayName = 'SearchPanelResultItem';

type SearchPanelListProps = {
  results: SearchHit[];
  locale: Locale;
...
export const SearchPanelList = ({
  ...
  query,
  listboxId,
}: SearchPanelListProps): ReactElement => {
