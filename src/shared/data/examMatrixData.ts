...
export const ATTACK_COLUMNS: AttackColumn[] = [
  { key: 'katate_dori', label: { en: 'Katate-dori', de: 'Katate-dori' } },
  { key: 'ryote_dori', label: { en: 'Ryōte-dori', de: 'Ryōte-dori' } },
  { key: 'katate_ryote_dori', label: { en: 'Katate-ryōte-dori', de: 'Katate-ryōte-dori' } },
  { key: 'mune_dori', label: { en: 'Mune-dori', de: 'Mune-dori' } },
  { key: 'yoko_kubi_shime', label: { en: 'Yoko-kubi-shime', de: 'Yoko-kubi-shime' } },
  { key: 'ushiro_ryokata_dori', label: { en: 'Ushiro-ryokata-dori', de: 'Ushiro-ryokata-dori' } },
  { key: 'ushiro_kakae_dori', label: { en: 'Ushiro-kakae-dori', de: 'Ushiro-kakae-dori' } },
  { key: 'ushiro_ryote_dori', label: { en: 'Ushiro-ryōte-dori', de: 'Ushiro-ryōte-dori' } },
  { key: 'ushiro_eri_dori', label: { en: 'Ushiro-eri-dori', de: 'Ushiro-eri-dori' } },
  { key: 'ushiro_katate_dori_kubi_shime', label: { en: 'Ushiro-katate-dori / kubi-shime', de: 'Ushiro-katate-dori / kubi-shime' } },
