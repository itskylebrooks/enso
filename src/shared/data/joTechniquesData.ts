...
export const JO_ROWS: JoRow[] = [
  {
    ...
    cells: {
      jo_ryote_tori_double: { kind: 'check' },
      jo_ryote_tori_gyaku: { kind: 'check' },
      jo_katate_tori: { kind: 'empty' },
      jo_katate_ryote_tori: { kind: 'empty' },
      jo_tsuki: { kind: 'check' },
  ...
  },
  {
    ...
    cells: {
      jo_ryote_tori_double: { kind: 'empty' },
      jo_ryote_tori_gyaku: { kind: 'empty' },
      jo_katate_tori: { kind: 'empty' },
      jo_katate_ryote_tori: { kind: 'empty' },
      jo_tsuki: { kind: 'check' },
  ...
  },
  {
    ...
    cells: {
      jo_ryote_tori_double: { kind: 'check' },
      jo_ryote_tori_gyaku: { kind: 'check' },
      jo_katate_tori: { kind: 'check' },
      jo_katate_ryote_tori: { kind: 'check' },
      jo_tsuki: { kind: 'check' },
      jo_yokomen_uchi: { kind: 'check' },
      jo_shomen_uchi: { kind: 'check' },
      jo_morote_awase_tsuki: { kind: 'empty' },
  ...
  {
    id: 'katate-tori-ushiro-kubi-shime',
