  ...
  aboutAuthorPart4: 'Outside the dojo, I study Software Systems Development at the University of Hamburg, and I build with React, TypeScript, and local-first principles. Enso is where those two paths meet — code and budō — where simplicity becomes practice, and practice becomes clarity.',
    ...
    feedbackPage: {
      ...
      placeholders: {
        ...
        variationName: 'Tenkan version',
        variationDescription: 'Short overview of what makes this version distinct.',
        ...
        variationCredit: 'Based on teaching of Markus Schmidt, Aikido Hamburg.',
        ...
        newTechniqueNameEn: 'e.g. Katate-dori Kaiten-nage',
        newTechniqueNameDe: 'z. B. Katate-dori Kaiten-nage',
        newTechniqueKanji: 'Optional kanji (小手返し)',
        newTechniqueRomaji: 'Optional romaji (kote-gaeshi)',
        ...
        newTechniqueSummaryEn: 'Short English summary (max 230 characters)',
        newTechniqueSummaryDe: 'Kurze deutsche Zusammenfassung (max. 230 Zeichen)',
        ...
        contributorContact: 'Email or contact (kept private)',
      },
      hints: {
      ...
      newTechnique: {
        ...
        fields: {
          name: {
            en: 'Technique name (English)',
            de: 'Technikname (Deutsch)',
          },
          jpKanji: 'Japanese kanji (optional)',
          romaji: 'Japanese romaji (optional)',
          attack: 'Primary attack',
          category: 'Category',
          weapon: 'Weapon',
          levelHint: 'Appears at grade / level',
          entries: 'Entry focus',
          hanmi: 'Hanmi',
          summary: {
            en: 'Summary (English)',
          ...
          slugPreview: 'Smart slug preview',
          mediaTitle: 'Media title',
          contributorName: 'Your name (public)',
          contributorContact: 'Contact (private)',
          source: 'Sources or attribution',
          lineage: 'Dojo / trainer attribution',
          ukeRole: {
            en: 'Uke role / intention (EN)',
            de: 'Uke-Rolle / Intention (DE)',
          },
          ukeNotes: {
            en: 'Uke notes (EN)',
            de: 'Uke notes (DE)',
          ...
          commonMistakes: {
            en: 'Common mistakes (EN)',
            de: 'Häufige Fehler (DE)',
          },
        },
        entryLabels: {
          irimi: 'Irimi',
        ...
        hints: {
          ...
          stepsLocalized: 'Steps are recorded per language; switch tabs to add English and German lines.',
        ...
        warnings: {
          summaryMissing: 'Provide a summary in both English and German.',
    ...
    feedbackPage: {
      ...
      forms: {
        ...
        variation: {
          ...
          variationNameLabel: 'Name der Variante',
          levelLabel: 'Grad (optional)',
          categoryTagsLabel: 'Kategorie-Tags',
          descriptionLabel: 'Beschreibung / Zusammenfassung',
          stepsLabel: 'Schritte',
          ukeLabel: 'Hinweise für Uke (optional)',
          mediaLabel: 'Medien (optional)',
          contextLabel: 'Kontext oder Notizen (optional)',
          creditLabel: 'Credits (optional)',
        },
        app: {
      ...
      placeholders: {
        ...
        credit: 'Anna S. - Aikido Hamburg.',
        variationName: 'Tenkan-Variante',
        variationDescription: 'Kurze Zusammenfassung, was diese Variante auszeichnet.',
        ...
        variationCredit: 'Basierend auf dem Unterricht von Markus Schmidt, Aikido Hamburg.',
        ...
        newTechniqueNameEn: 'z. B. Katate-dori Kaiten-nage (EN)',
        newTechniqueNameDe: 'z. B. Katate-dori Kaiten-nage (DE)',
        newTechniqueKanji: 'Optionales Kanji (小手返し)',
        newTechniqueRomaji: 'Optionales Romaji (kote-gaeshi)',
        ...
        newTechniqueSummaryEn: 'Kurze englische Zusammenfassung (max. 230 Zeichen)',
        newTechniqueSummaryDe: 'Kurze deutsche Zusammenfassung (max. 230 Zeichen)',
        ...
        contributorContact: 'E-Mail oder Kontakt (nicht öffentlich)',
      },
      hints: {
      ...
      newTechnique: {
        ...
        sections: {
          ...
          media: 'Medien',
          contributor: 'Ansprechperson & Linie',
        },
        fields: {
          name: {
            en: 'Technikname (Englisch)',
            de: 'Technikname (Deutsch)',
          },
          jpKanji: 'Japanische Kanji (optional)',
          romaji: 'Japanisches Romaji (optional)',
          attack: 'Primärer Angriff',
          category: 'Kategorie',
          weapon: 'Waffe',
          levelHint: 'Erscheint bei Grad / Stufe',
          entries: 'Eingänge',
          hanmi: 'Hanmi',
          summary: {
            en: 'Zusammenfassung (Englisch)',
            de: 'Zusammenfassung (Deutsch)',
          },
          slugPreview: 'Slug-Vorschau',
          mediaTitle: 'Medientitel',
          contributorName: 'Dein Name (öffentlich)',
          contributorContact: 'Kontakt (nicht öffentlich)',
          source: 'Quellen oder Attribution',
          lineage: 'Dojo-/Trainer-Zuschreibung',
          ukeRole: {
            en: 'Uke-Rolle / Intention (EN)',
            de: 'Uke-Rolle / Intention (DE)',
          },
          ukeNotes: {
            en: 'Uke-Hinweise (EN)',
        ...
        hints: {
          ...
          slugPreview: 'Slug setzt sich aus Angriff, Name und Eingang zusammen.',
          stepsLocalized: 'Schritte werden je Sprache gepflegt; wechsle die Ansicht, um englische und deutsche Zeilen einzutragen.',
          unusualCombo: 'Diese Angriff-/Waffen-Kombination ist ungewöhnlich. Bitte erneut prüfen oder im Kontext erläutern.',
        },
        mediaRestrictions: 'Für neue Techniken werden nur YouTube-(No-Cookie)- und Bild-Links akzeptiert.',
        warnings: {
          summaryMissing: 'Bitte gib eine Zusammenfassung in Deutsch und Englisch an.',
          consentMissing: 'Zum Absenden musst du den Nutzungsrechten zustimmen.',
        },
        duplicates: {
          possibleMatches: 'Mögliche Dubletten erkannt',
          none: 'Derzeit keine Dubletten erkannt.',
