...
export const messages = {
  ...
  aboutAuthorPart4: 'Außerhalb des Dōjō studiere ich an der Universität Hamburg und arbeite mit React, TypeScript und lokalen Speicherprinzipien. Enso ist der Ort, an dem sich diese beiden Wege treffen — Code und Budō — wo Einfachheit zur Übung wird, und Übung zu Klarheit.',
    ...
    feedbackDescription: 'Hilf Enso zu wachsen, indem du bestehende Inhalte verbesserst oder deine Perspektive einbringst. Ob kleine Korrektur oder komplette Variation – dein Aikidō-Wissen zählt.',
    feedbackPage: {
      heroSubtitle: 'Hilf Enso zu wachsen, indem du bestehende Inhalte verbesserst oder deine Perspektive einbringst. Ob kleine Korrektur oder komplette Variation - dein Aikidō-Wissen zählt.',
      headings: {
