...
export const messages = {
  ...
  trainerBaseForms: 'Base forms',
    ...
    mediaDabAttribution: 'Source: Deutscher Aikido-Bund e.V.\nLicensed under CC BY 3.0 DE\n(Video embedded, used without modification.)',
    version: 'Version',
    compare: 'Compare',
  ...
  de: {
    ...
    mediaDabAttribution: 'Quelle: Deutscher Aikido-Bund e.V.\nLizenziert unter CC BY 3.0 DE\n(Video eingebettet, unverändert übernommen.)',
    version: 'Variante',
    compare: 'Vergleichen',
