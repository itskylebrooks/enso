export const en = {
  ...
  collectionsAll: 'All saved items',
  ...
  learn: 'Learn',
  learnCardSetLabel: 'Cards',
  learnCardSetStandard: 'Content',
  learnCardSetPronunciation: 'Pronunciation',
  learnCardSetJapaneseWriting: 'Writing',
  learnModeLabel: 'Show first',
  learnModeTitleFirst: 'Title',
  learnModeDefinitionFirst: 'Definition',
  learnModePronunciationFirst: 'Pronunciation',
  learnModeJapaneseWritingFirst: 'Japanese writing',
  learnOrderLabel: 'Order',
  learnOrderCurrent: 'As shown',
  learnOrderRandom: 'Random',
  learnTagsLabel: 'Show tags',
  learnStart: 'Start',
  ...
  learnTapToReveal: 'Tap the card or Reveal to show it.',
  learnReveal: 'Reveal',
  learnRemembered: 'Remembered',
  learnForgot: 'Not remembered',
  learnProgress: 'Card {current} of {total}',
  learnCompleteEyebrow: 'Session complete',
  ...
  settings: 'Settings',
  showTeachInPrimaryNav: 'Trainer tools',
  language: 'Language',
  theme: 'Theme',
  light: 'Light',
  dark: 'Dark',
