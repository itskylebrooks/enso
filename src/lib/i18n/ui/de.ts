export const de = {
  ...
  collectionsAll: 'Alle gespeicherten Einträge',
  ...
  collectionsEmptyAll:
    'Noch keine gespeicherten Einträge. Durchstöbere die Bibliothek und tippe das Icon zum Speichern.',
  ...
  collectionsStudyGroup: 'Lernen',
  collectionsStudyPractice: 'Übung',
  collectionsStudyStable: 'Stabil',
  learn: 'Lernen',
  learnCardSetLabel: 'Karten',
  learnCardSetStandard: 'Inhalte',
  learnCardSetPronunciation: 'Aussprache',
  learnCardSetJapaneseWriting: 'Schrift',
  learnModeLabel: 'Zuerst anzeigen',
  learnModeTitleFirst: 'Titel',
  learnModeDefinitionFirst: 'Definition',
  learnModePronunciationFirst: 'Aussprache',
  learnModeJapaneseWritingFirst: 'Japanische Schrift',
  learnOrderLabel: 'Reihenfolge',
  learnOrderCurrent: 'Wie angezeigt',
  learnOrderRandom: 'Zufällig',
  learnTagsLabel: 'Tags anzeigen',
  learnStart: 'Starten',
  ...
  learnTapToReveal: 'Tippe auf die Karte oder Aufdecken, um sie zu zeigen.',
  learnReveal: 'Aufdecken',
  learnRemembered: 'Gewusst',
  learnForgot: 'Nicht gewusst',
  learnProgress: 'Karte {current} von {total}',
  learnCompleteEyebrow: 'Sitzung beendet',
  ...
  showTeachInPrimaryNav: 'Trainer-Werkzeuge',
  language: 'Sprache',
  theme: 'Thema',
  light: 'Hell',
  dark: 'Dunkel',
  ...
  studyMarkPractice: 'Als Übung markieren',
  studyMarkStable: 'Als stabil markieren',
  studyClearStatus: 'Status löschen',
